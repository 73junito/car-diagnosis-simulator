...
(function(){
  function showToast(msg, timeout=3000){
    try { if (window.showToast) return window.showToast(msg, timeout); } catch(e){}
  ...
  function getAccessToken(){
    try { if (window._getAccessTokenImpl) return window._getAccessTokenImpl(); } catch(e){}
    return localStorage.getItem('supabase_access_token') || null;
  }

  function clearLocalFallbackOnAuth(){
    try { if (window.clearLocalFallbackOnAuth) return window.clearLocalFallbackOnAuth(); } catch(e){}

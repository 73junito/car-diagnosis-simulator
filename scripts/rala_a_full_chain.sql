select
  ...
  qp.status as provenance_status,
  qc.id as citation_id,
  qc.role as citation_role,
  qc.locator,
  qc.quote,
  qc.chunk_id,
  sc.source_id as chunk_source_id,
  sc.title as chunk_title,
  sc.section as chunk_section,
  sc.page_start,
  sc.page_end,
  sc.status as chunk_status,
  sc.approved as chunk_approved,
  qc.source_id as citation_source_id,
...
order by qp.question_id, qp.provenance_version, qc.role, qc.id;

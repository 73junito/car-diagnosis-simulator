...
COMMENT ON TABLE public.citation_role_migration_audit IS
    'Audit trail for question_citations role migration. Captures records using the legacy supports-ase-concept role that were archived during the forward migration to remove it.';

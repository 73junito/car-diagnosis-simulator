...
function saveProgress(){
  ...
  // Save progress (Firestore if available, otherwise localStorage)
  ...
  // Load user data (Firestore if available)
  ...
  // Load teacher data from Firestore if available, otherwise from localStorage
  ...
  // Export all: if Firestore available, fetch and export; otherwise use localStorage
